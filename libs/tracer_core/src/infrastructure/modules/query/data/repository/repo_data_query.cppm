...
export module tracer.core.infrastructure.query.data.repository.data_query_repository;
...
using ::tracer::core::infrastructure::query::data::QueryDayDurationsByRootInDateRange;
