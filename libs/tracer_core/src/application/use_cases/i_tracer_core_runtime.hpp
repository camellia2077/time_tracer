#ifndef APPLICATION_USE_CASES_I_TRACER_CORE_RUNTIME_HPP_
#define APPLICATION_USE_CASES_I_TRACER_CORE_RUNTIME_HPP_
...
#endif  // APPLICATION_USE_CASES_I_TRACER_CORE_RUNTIME_HPP_
