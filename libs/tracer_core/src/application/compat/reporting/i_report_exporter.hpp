// application/compat/reporting/i_report_exporter.hpp
#ifndef APPLICATION_COMPAT_REPORTING_I_REPORT_EXPORTER_H_
#define APPLICATION_COMPAT_REPORTING_I_REPORT_EXPORTER_H_
...
#endif  // APPLICATION_COMPAT_REPORTING_I_REPORT_EXPORTER_H_
