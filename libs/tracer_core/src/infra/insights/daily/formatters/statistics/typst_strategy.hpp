// infra/insights/daily/formatters/statistics/typst_strategy.hpp
#ifndef INFRASTRUCTURE_INSIGHTS_DAILY_FORMATTERS_STATISTICS_TYPST_STRATEGY_H_
#define INFRASTRUCTURE_INSIGHTS_DAILY_FORMATTERS_STATISTICS_TYPST_STRATEGY_H_
