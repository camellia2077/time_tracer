// infra/insights/daily/formatters/statistics/stat_formatter.hpp
#ifndef INFRASTRUCTURE_INSIGHTS_DAILY_FORMATTERS_STATISTICS_STAT_FORMATTER_H_
#define INFRASTRUCTURE_INSIGHTS_DAILY_FORMATTERS_STATISTICS_STAT_FORMATTER_H_
...
DISABLE_C4251_WARNING  // <-- [新增] 2. 禁用C4251 (因为有 std::unique_ptr)
    ...
    class INSIGHTS_SHARED_API StatFormatter {  // <-- [修改] 3. 添加API宏
 public:
  /**
   * @brief 构造函数。
...
#endif  // INFRASTRUCTURE_INSIGHTS_DAILY_FORMATTERS_STATISTICS_STAT_FORMATTER_H_