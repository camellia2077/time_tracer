// infra/insights/shared/config/tex_style_config.hpp
#ifndef INFRASTRUCTURE_INSIGHTS_SHARED_CONFIG_TEX_STYLE_CONFIG_H_
#define INFRASTRUCTURE_INSIGHTS_SHARED_CONFIG_TEX_STYLE_CONFIG_H_
...
class INSIGHTS_SHARED_API TexStyleConfig {
 public:
...
#endif  // INFRASTRUCTURE_INSIGHTS_SHARED_CONFIG_TEX_STYLE_CONFIG_H_
