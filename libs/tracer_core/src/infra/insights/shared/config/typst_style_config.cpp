// infra/insights/shared/config/typst_style_config.cpp
...
TypstStyleConfig::TypstStyleConfig(const FontConfig& fonts,
  ...
  insights_title_font_size_ = fonts.insights_title_font_size;
...
auto TypstStyleConfig::GetInsightsTitleFontSize() const -> int {
  return insights_title_font_size_;
}
