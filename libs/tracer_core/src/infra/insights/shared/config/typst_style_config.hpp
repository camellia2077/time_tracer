// infra/insights/shared/config/typst_style_config.hpp
#ifndef INFRASTRUCTURE_INSIGHTS_SHARED_CONFIG_TYPST_STYLE_CONFIG_H_
#define INFRASTRUCTURE_INSIGHTS_SHARED_CONFIG_TYPST_STYLE_CONFIG_H_
...
class INSIGHTS_SHARED_API TypstStyleConfig {
 public:
...
#endif  // INFRASTRUCTURE_INSIGHTS_SHARED_CONFIG_TYPST_STYLE_CONFIG_H_
