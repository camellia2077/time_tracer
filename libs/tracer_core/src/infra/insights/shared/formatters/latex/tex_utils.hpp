// infra/insights/shared/formatters/latex/tex_utils.hpp
#ifndef INFRASTRUCTURE_INSIGHTS_SHARED_FORMATTERS_LATEX_TEX_UTILS_H_
#define INFRASTRUCTURE_INSIGHTS_SHARED_FORMATTERS_LATEX_TEX_UTILS_H_
...
[[nodiscard]] INSIGHTS_SHARED_API auto GetTexPreamble(
 ...
 */
[[nodiscard]] INSIGHTS_SHARED_API auto GetTexPostfix() -> std::string;
 ...
 * @return 转义后的字符串。
 */
[[nodiscard]] INSIGHTS_SHARED_API auto EscapeLatex(const std::string& input)
    -> std::string;
...
// Public API: keep parameter order and naming for ABI compatibility.
// NOLINTBEGIN(bugprone-easily-swappable-parameters)
[[nodiscard]] INSIGHTS_SHARED_API auto FormatProjectTree(
...
#endif  // INFRASTRUCTURE_INSIGHTS_SHARED_FORMATTERS_LATEX_TEX_UTILS_H_
