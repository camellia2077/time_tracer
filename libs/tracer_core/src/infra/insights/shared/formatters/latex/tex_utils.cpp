// infra/insights/shared/formatters/latex/tex_utils.cpp
...
class LatexFormattingStrategy : public insights::IFormattingStrategy {
 public:
...
auto FormatProjectTree(
    const insights::ProjectTree& tree,  // [修改] 加上 insights:: 命名空间
