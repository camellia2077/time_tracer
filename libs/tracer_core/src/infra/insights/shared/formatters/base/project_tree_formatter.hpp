// infra/insights/shared/formatters/base/project_tree_formatter.hpp
#ifndef INFRASTRUCTURE_INSIGHTS_SHARED_FORMATTERS_BASE_PROJECT_TREE_FORMATTER_H_
#define INFRASTRUCTURE_INSIGHTS_SHARED_FORMATTERS_BASE_PROJECT_TREE_FORMATTER_H_
 ...
 */
class INSIGHTS_SHARED_API IFormattingStrategy {
 public:
  ...
  [[nodiscard]] virtual auto EndChildrenList() const -> std::string {
    return "";
  }
};
 ...
 */
class INSIGHTS_SHARED_API ProjectTreeFormatter {  // [新增] 必须添加 API 宏
 public:
  /**
 ...
 private:
  std::unique_ptr<IFormattingStrategy> m_strategy_;

  // NOLINTBEGIN(bugprone-easily-swappable-parameters)
  void GenerateSortedOutput(std::string& output, const ProjectNode& node,
...
#endif  // INFRASTRUCTURE_INSIGHTS_SHARED_FORMATTERS_BASE_PROJECT_TREE_FORMATTER_H_
