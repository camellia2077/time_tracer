// infra/insights/data/queriers/period/period_querier.cpp
...
void PeriodQuerier::HandleInvalidInput(PeriodInsightsData& data) const {
  data.is_valid = false;
}

void PeriodQuerier::PrepareData(PeriodInsightsData& data) const {
