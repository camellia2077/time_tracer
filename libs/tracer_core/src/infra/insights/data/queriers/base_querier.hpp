// infra/insights/data/queriers/base_querier.hpp
#ifndef INFRASTRUCTURE_INSIGHTS_DATA_QUERIERS_BASE_QUERIER_H_
#define INFRASTRUCTURE_INSIGHTS_DATA_QUERIERS_BASE_QUERIER_H_
...
class BaseQuerier {
 public:
  ...
  virtual auto FetchData() -> InsightsDataType {
 ...
 protected:
  ...
  virtual void HandleInvalidInput(InsightsDataType& /*data*/) const {
    // Default implementation does nothing.
  }

  // [FIX] Silenced unused parameter warning.
  virtual void PrepareData(InsightsDataType& /*data*/) const {
    // Default implementation does nothing.
  }

  virtual void FinalizeData(InsightsDataType& /*data*/) const {
    // Default implementation does nothing.
  }

  void FetchRecordsAndDuration(InsightsDataType& data) {
    sqlite3_stmt* stmt;

    // Insights total_duration is defined as the sum of persisted activity
  ...
  // flow.
  void FetchActualDays(InsightsDataType& data) {
    sqlite3_stmt* stmt;
...
#endif  // INFRASTRUCTURE_INSIGHTS_DATA_QUERIERS_BASE_QUERIER_H_
