// infra/insights/data/queriers/range/date_range_querier.cpp
...
void DateRangeQuerier::HandleInvalidInput(PeriodInsightsData& data) const {
...
void DateRangeQuerier::PrepareData(PeriodInsightsData& data) const {
  int requested_days = 0;
