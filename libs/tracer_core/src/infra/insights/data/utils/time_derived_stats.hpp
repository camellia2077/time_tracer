#ifndef INFRASTRUCTURE_INSIGHTS_DATA_UTILS_TIME_DERIVED_STATS_H_
#define INFRASTRUCTURE_INSIGHTS_DATA_UTILS_TIME_DERIVED_STATS_H_
...
namespace tracer::core::infrastructure::insights::data::stats {
...
class DerivedTimeStatsAggregator {
 public:
  ...
  [[nodiscard]] auto BuildInsightsStatsMap() const
...
#endif  // INFRASTRUCTURE_INSIGHTS_DATA_UTILS_TIME_DERIVED_STATS_H_
