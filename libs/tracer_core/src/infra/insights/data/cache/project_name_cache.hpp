// infra/insights/data/cache/project_name_cache.hpp
#ifndef INFRASTRUCTURE_INSIGHTS_DATA_CACHE_PROJECT_NAME_CACHE_H_
#define INFRASTRUCTURE_INSIGHTS_DATA_CACHE_PROJECT_NAME_CACHE_H_
...
class ProjectNameCache : public IProjectInfoProvider {
 public:
  ...
  auto EnsureLoaded(sqlite3* sqlite_db)
    ...
    // can become stale after ingest/replace operations and corrupt insights
...
#endif  // INFRASTRUCTURE_INSIGHTS_DATA_CACHE_PROJECT_NAME_CACHE_H_
