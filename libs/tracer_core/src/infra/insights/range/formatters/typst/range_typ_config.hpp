// infra/insights/range/formatters/typst/range_typ_config.hpp
#ifndef INFRASTRUCTURE_INSIGHTS_RANGE_FORMATTERS_TYPST_RANGE_TYP_CONFIG_H_
#define INFRASTRUCTURE_INSIGHTS_RANGE_FORMATTERS_TYPST_RANGE_TYP_CONFIG_H_
...
class RangeTypConfig : public RangeBaseConfig {
 public:
  RangeTypConfig(const RangeInsightsLabels& labels, const FontConfig& fonts,
...
#endif  // INFRASTRUCTURE_INSIGHTS_RANGE_FORMATTERS_TYPST_RANGE_TYP_CONFIG_H_
