// infra/insights/range/common/range_base_config.hpp
#ifndef INFRASTRUCTURE_INSIGHTS_RANGE_COMMON_RANGE_BASE_CONFIG_H_
#define INFRASTRUCTURE_INSIGHTS_RANGE_COMMON_RANGE_BASE_CONFIG_H_
...
class INSIGHTS_SHARED_API RangeBaseConfig {
 public:
...
#endif  // INFRASTRUCTURE_INSIGHTS_RANGE_COMMON_RANGE_BASE_CONFIG_H_
