// infra/persistence/sqlite_data_query_service_period.cpp
#include <cctype>
#include <chrono>
#include <format>
#include <stdexcept>
...
auto ApplyTreePeriodDay(const tracer_core::core::dto::DataQueryRequest& request,
...
auto ApplyTreePeriod(const tracer_core::core::dto::DataQueryRequest& request,
