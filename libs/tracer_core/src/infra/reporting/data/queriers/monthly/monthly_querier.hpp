// infra/reporting/data/queriers/monthly/monthly_querier.hpp
...
#include "infra/reporting/data/queriers/range_querier_base.hpp"
...
class BatchMonthDataFetcher {
 ...
 private:
  ...
  void FetchSleepDays(std::map<std::string, int>& sleep_days);
};
