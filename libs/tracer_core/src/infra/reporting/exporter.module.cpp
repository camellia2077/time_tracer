...
#include "infra/reporting/exporter.hpp"
...
import tracer.core.infrastructure.reporting.exporting.export_utils;
import tracer.core.infrastructure.reporting.exporting.report_file_manager;
...
void Exporter::WriteReportToFile(std::string_view report_content,
  ...
  try {
    ...
    infra_file_io::WriteCanonicalText(output_path, report_content);
