// infra/reporting/range/formatters/latex/range_tex_formatter.hpp
#ifndef INFRASTRUCTURE_REPORTS_RANGE_FORMATTERS_LATEX_RANGE_TEX_FORMATTER_H_
#define INFRASTRUCTURE_REPORTS_RANGE_FORMATTERS_LATEX_RANGE_TEX_FORMATTER_H_

#include <memory>

#include "domain/reports/models/range_report_data.hpp"
#include "infra/reporting/range/formatters/latex/range_tex_config.hpp"
#include "infra/reporting/shared/formatters/templates/base_tex_formatter.hpp"
...
#endif  // INFRASTRUCTURE_REPORTS_RANGE_FORMATTERS_LATEX_RANGE_TEX_FORMATTER_H_
