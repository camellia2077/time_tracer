// infra/reporting/range/formatters/latex/range_tex_config.hpp
#ifndef INFRASTRUCTURE_REPORTS_RANGE_FORMATTERS_LATEX_RANGE_TEX_CONFIG_H_
#define INFRASTRUCTURE_REPORTS_RANGE_FORMATTERS_LATEX_RANGE_TEX_CONFIG_H_

#include <string>

#include "infra/config/models/report_config_models.hpp"
#include "infra/reporting/range/common/range_base_config.hpp"
#include "infra/reporting/shared/config/tex_style_config.hpp"
...
#endif  // INFRASTRUCTURE_REPORTS_RANGE_FORMATTERS_LATEX_RANGE_TEX_CONFIG_H_
