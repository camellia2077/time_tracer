// infra/reports/monthly/formatters/latex/month_tex_utils.cpp
#include "infra/reports/monthly/formatters/latex/month_tex_utils.hpp"

#include "infra/reports/shared/formatters/latex/tex_common_utils.hpp"
