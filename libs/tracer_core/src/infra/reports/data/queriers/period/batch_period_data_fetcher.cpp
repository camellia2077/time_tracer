// infra/reports/data/queriers/period/batch_period_data_fetcher.cpp
...
#include "infra/reports/data/cache/project_name_cache.hpp"  // 引入名称缓存作为 Provider
#include "infra/reports/data/queriers/utils/batch_aggregation.hpp"
#include "infra/reports/data/utils/time_derived_stats.hpp"
#include "infra/reports/shared/utils/format/time_format.hpp"  // 需要用到 AddDaysToDateStr
