// infra/reports/shared/formatters/templates/base_tex_formatter.hpp
#ifndef INFRASTRUCTURE_REPORTS_SHARED_FORMATTERS_TEMPLATES_BASE_TEX_FORMATTER_H_
#define INFRASTRUCTURE_REPORTS_SHARED_FORMATTERS_TEMPLATES_BASE_TEX_FORMATTER_H_

#include <map>
#include <memory>
#include <string>

#include "infra/reports/shared/formatters/latex/tex_utils.hpp"
...
#endif  // INFRASTRUCTURE_REPORTS_SHARED_FORMATTERS_TEMPLATES_BASE_TEX_FORMATTER_H_
