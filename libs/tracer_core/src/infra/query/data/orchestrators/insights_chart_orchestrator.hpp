// infra/query/data/orchestrators/insights_chart_orchestrator.hpp
#pragma once
...
#include "infra/query/data/orchestrators/detail/insights_chart_orchestrator_decl.inc"
...
using tracer::core::infrastructure::query::data::orchestrators::
    HandleInsightsCompositionQuery;
