// infra/query/data/renderers/text_renderer.cpp
#include "infra/query/data/renderers/text_renderer.hpp"
...
void AppendTreeChildren(std::ostringstream& output_stream,
                        const ProjectTreeNode& node, const std::string& prefix,
...
auto RenderProjectTreeText(const std::vector<ProjectTreeNode>& nodes,
