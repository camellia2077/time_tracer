...
[[nodiscard]] auto BuildCompositionTreePayload(
    const std::vector<infra_data_query_stats::ReportCompositionTreeNodeView>&
        tree,
    const infra_data_query_stats::ReportCompositionStats& stats) -> json {
...
auto ResolveReportQueryWindow(
    ...
    const infra_data_query_orchestrators::ExplicitDateRangeErrors&
        explicit_range_errors) -> ResolvedReportQueryWindow {
...
auto ValidateReportCompositionRequest(
  ...
  const infra_data_query_orchestrators::ExplicitDateRangeErrors kRangeErrors{
      ...
      .validation =
          {
              .invalid_range_error = "report-composition invalid range: "
...
auto BuildReportCompositionContent(
  ...
  const reporting::ProjectTree kTree =
  ...
  payload["tree"] = BuildCompositionTreePayload(
      infra_data_query_stats::BuildReportCompositionTreeView(kTree),
      kCompositionStats);
