...
auto RunInfrastructureModuleQueryInternalOrchestratorsSmoke() -> int {
  ...
  const auto kHandleYearsQuery = &tracer::core::infrastructure::query::data::
                                     orchestrators::HandleYearsQuery;
  const auto kHandleMonthsQuery = &tracer::core::infrastructure::query::data::
                                      orchestrators::HandleMonthsQuery;
  const auto kHandleDaysQuery = &tracer::core::infrastructure::query::data::
                                    orchestrators::HandleDaysQuery;
  ...
  const auto explicit_errors = tracer::core::infrastructure::query::data::
      orchestrators::ExplicitDateRangeErrors{
  ...
  const auto explicit_range =
      tracer::core::infrastructure::query::data::orchestrators::
          ResolveExplicitDateRange("2026-02-01", "2026-02-07", explicit_errors);
  ...
  const auto rolling_range = tracer::core::infrastructure::query::data::
      orchestrators::ResolveRollingDateRange(7);
  ...
  try {
    ...
    const auto years_output = tracer::core::infrastructure::query::data::
        orchestrators::HandleYearsQuery(
            connection.GetDb(),
    ...
    const auto months_output = tracer::core::infrastructure::query::data::
        orchestrators::HandleMonthsQuery(
    ...
    const auto days_output =
        tracer::core::infrastructure::query::data::orchestrators::
            HandleDaysQuery(connection.GetDb(), base_filters,
                            tracer_core::core::dto::DataQueryOutputMode::kText);
    if (!days_output.ok ||
    ...
    const auto days_stats_output = tracer::core::infrastructure::query::data::
        orchestrators::HandleDaysStatsQuery(
    ...
    const auto tree_output =
        tracer::core::infrastructure::query::data::orchestrators::
            HandleTreeQuery(connection.GetDb(), tree_request, base_filters,
                            tracer_core::core::dto::DataQueryOutputMode::kText);
    if (!tree_output.ok ||
