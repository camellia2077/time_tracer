...
<body>
  ...
  <script id="insights-chart-data" type="application/json">{{INSIGHTS_CHART_JSON}}</script>
  <script>
    (() => {
      const chartKind = '{{CHART_KIND}}';
      const chartTheme = '{{CHART_THEME}}';
      const raw = document.getElementById('insights-chart-data');
      ...
      // insights-composition exposes the complete weighted tree. The pie chart
