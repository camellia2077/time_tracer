use crate::cli::InsightsRenderArgs;
...
use super::{InsightsSessionPort, RuntimeInsightsSessionPort};

pub struct RenderHandler;

impl CommandHandler<InsightsRenderArgs> for RenderHandler {
    fn handle(&self, args: InsightsRenderArgs, ctx: &CommandContext) -> Result<(), AppError> {
        run_render_with_port(args, ctx, &RuntimeInsightsSessionPort)
    }
}
