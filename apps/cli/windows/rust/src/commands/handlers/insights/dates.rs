use crate::cli::InsightsExportPeriod;
...
pub(crate) fn normalize_export_argument(
    ...
    match period {
        InsightsExportPeriod::Day => normalize_day_argument("`insights export day`", argument),
        InsightsExportPeriod::Month => normalize_month_argument("`insights export month`", argument),
        InsightsExportPeriod::Week => normalize_week_argument("`insights export week`", argument),
        InsightsExportPeriod::Year => normalize_year_argument("`insights export year`", argument),
        InsightsExportPeriod::Recent => normalize_recent_argument("`insights export recent`", argument),
        InsightsExportPeriod::Range => normalize_range_argument("`insights export range`", argument),
    }
}
