...
- Always reuse `out/build/log_generator/build_fast` for incremental builds.
...
- Main aggregated log: `out/test/artifact_log_generator/logs/output.log`
- Case logs: `out/test/artifact_log_generator/logs/**`
...
- `out/test/artifact_log_generator/result.json` exists and has `"success": true`.
