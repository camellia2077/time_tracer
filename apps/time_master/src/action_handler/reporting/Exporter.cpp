...
Exporter::Exporter(sqlite3* db, const fs::path& export_root_path, const AppConfig& config)
    : db_(db), export_root_path_(export_root_path), app_config_(config) {}

void Exporter::run_export_single_day_report(const std::string& date, ReportFormat format) const {
...
void Exporter::run_export_single_month_report(const std::string& month, ReportFormat format) const {
    // [MODIFIED] Pass the AppConfig to the QueryHandler
    QueryHandler query_handler(db_, app_config_);
...
void Exporter::run_export_single_period_report(int days, ReportFormat format) const {
    // [MODIFIED] Pass the AppConfig to the QueryHandler
    QueryHandler query_handler(db_, app_config_);
...
void Exporter::run_export_all_daily_reports_query(ReportFormat format) const {
    // [MODIFIED] Pass the AppConfig to the QueryHandler
    QueryHandler query_handler(db_, app_config_);
...
void Exporter::run_export_all_monthly_reports_query(ReportFormat format) const {
    // [MODIFIED] Pass the AppConfig to the QueryHandler
    QueryHandler query_handler(db_, app_config_);
...
void Exporter::run_export_all_period_reports_query(const std::vector<int>& days_list, ReportFormat format) const {
    // [MODIFIED] Pass the AppConfig to the QueryHandler
    QueryHandler query_handler(db_, app_config_);
