// tracer_windows/src/bootstrap/cli_runtime_factory.cpp
#include <cctype>
#include <filesystem>
#include <iostream>
#include <memory>
...
using time_tracer::cli::bootstrap::internal::CliRuntimeState;
using time_tracer::cli::bootstrap::internal::CoreLibrary;
using time_tracer::cli::bootstrap::internal::ParseResolvedCliContextFromCore;
using time_tracer::cli::bootstrap::internal::ParseRuntimeCheckResult;
using time_tracer::cli::bootstrap::internal::ResolvedCliContextFromCore;
using time_tracer::cli::bootstrap::internal::RuntimeCheckResult;
using time_tracer::cli::bootstrap::internal::ValidateRequiredRuntimeFiles;
...
ClassifyValidationFailureFromMessage(std::string_view message)
  ...
  if (ContainsToken(text, "missing required runtime file") ||
      ContainsToken(text, "time_tracer_core.dll") ||
...
public:
  ...
  [[nodiscard]] auto BuildRuntime(
    ...
    CliRuntime runtime;
    auto proxy = time_tracer::cli::bootstrap::internal::MakeCoreApiProxy(
