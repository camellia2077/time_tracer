...
print_usage() {
  ...
  echo "  $0 --runpy-args --cmake-args=-DENABLE_LTO=OFF --build-args --target tracer_windows_cli_assets_sync"
}
...
echo "[tracer_windows_cli build_release] profile=release_bundle"
