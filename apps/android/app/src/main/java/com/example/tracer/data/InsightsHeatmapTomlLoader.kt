...
internal object InsightsHeatmapTomlLoader {
    ...
    suspend fun load(configGateway: ConfigGateway): InsightsHeatmapTomlConfig {
        val readResult = configGateway.readConfigTomlFile(HeatmapConfigPath)
        if (!readResult.ok || readResult.content.isBlank()) {
            return defaultInsightsHeatmapTomlConfig()
        }
    ...
    fun parse(rawToml: String): InsightsHeatmapTomlConfig {
        val fallback = defaultInsightsHeatmapTomlConfig()
        ...
        return InsightsHeatmapTomlConfig(
    ...
    fun deriveStylePreference(config: InsightsHeatmapTomlConfig): InsightsHeatmapStylePreference {
        ...
        if (
            ...
            return InsightsHeatmapStylePreference(
