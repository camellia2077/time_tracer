...
internal fun SegmentedAnalysisPeriodInputs(
    ...
    InsightsTemporalInputFields(
        ...
        labels = TemporalInputLabels(
            dayTitle = stringResource(R.string.insights_title_section_day, section),
            monthTitle = stringResource(R.string.insights_title_section_month, section),
            weekTitle = stringResource(R.string.insights_title_section_week, section),
            yearLabel = stringResource(R.string.insights_label_section_year, section),
            rangeStartTitle = stringResource(R.string.insights_title_section_start_date, section),
            rangeEndTitle = stringResource(R.string.insights_title_section_end_date, section),
            recentDaysLabel = stringResource(R.string.insights_label_section_recent_days, section)
        ),
        keyboardOptions = keyboardOptions,
            ...
            Row(
                ...
                Icon(
                    ...
                    contentDescription = if (expanded) {
                        stringResource(R.string.insights_cd_collapse)
                    } else {
                        stringResource(R.string.insights_cd_expand)
                    },
                    tint = MaterialTheme.colorScheme.primary
                )
            }
