...
internal fun QueryYearMonthDropdownInput(
    ...
    val (rawYear, rawMonth) = splitYearMonthDigits(insightsMonth)
        ...
        DropdownMenu(
            ...
            years.forEach { year ->
                DropdownMenuItem(
                    text = { Text(year) },
                    onClick = {
                        onInsightsMonthChange(mergeYearMonthDigits(year, selectedMonth))
                        yearExpanded = false
                    }
                )
            }
        ...
        DropdownMenu(
            ...
            months.forEach { month ->
                DropdownMenuItem(
                    text = { Text(month) },
                    onClick = {
                        onInsightsMonthChange(mergeYearMonthDigits(selectedYear, month))
                        monthExpanded = false
                    }
                )
            }
