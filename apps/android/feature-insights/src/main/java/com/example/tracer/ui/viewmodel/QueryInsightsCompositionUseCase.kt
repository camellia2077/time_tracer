...
internal class QueryInsightsCompositionUseCase(
    ...
    suspend fun execute(
        ...
        val queryResult = queryGateway.queryInsightsComposition(
            InsightsCompositionQueryParams(
                lookbackDays = params.lookbackDays,
    ...
    private fun computeParameterHash(key: CompositionQueryCacheKey): String {
        val raw = "${key.insightsMode}|${key.lookbackDays}|${key.fromDateIso}|" +
