...
@Composable
internal fun InsightsMarkdownText(
    markdown: String,
    modifier: Modifier = Modifier,
    style: TextStyle = MaterialTheme.typography.bodyMedium,
    color: Color = MaterialTheme.colorScheme.onSurface
) {
    val sections = remember(markdown) { parseInsightsMarkdownSections(markdown) }
...
@Composable
private fun InsightsMarkdownHeader(
...
@Composable
private fun InsightsMarkdownBlock(
    block: MarkdownBlock,
    style: TextStyle,
    color: Color
) {
