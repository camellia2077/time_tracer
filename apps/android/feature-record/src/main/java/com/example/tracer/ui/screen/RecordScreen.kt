...
fun RecordSection(
    ...
    canonicalCatalogSearchQuery: String,
    onCanonicalCatalogSearchQueryChange: (String) -> Unit,
    ...
    if (isCanonicalCatalogVisible) {
        ...
        if (canonicalBrowserTarget == CanonicalBrowserTarget.RECORD_INPUT) {
            RecordCanonicalCatalogScreen(
                ...
                searchQuery = canonicalCatalogSearchQuery,
                onSearchQueryChange = onCanonicalCatalogSearchQueryChange,
