...
interface RecordTextProvider {
    fun recordedActivityStatus(canonicalToken: String, durationText: String): String
    fun unavailableDuration(): String
}

object DefaultRecordTextProvider : RecordTextProvider {
    override fun recordedActivityStatus(canonicalToken: String, durationText: String): String =
        "$canonicalToken\n$durationText"
