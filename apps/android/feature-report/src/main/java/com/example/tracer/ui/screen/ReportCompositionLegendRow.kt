...
internal fun CompositionLegendRow(
    ...
    Row(
        ...
        Column(
            ...
            Text(
                text = stringResource(
                    if (showFrequency) R.string.report_chart_composition_total_records
                    else R.string.report_chart_composition_total_duration,
            ...
            if (showAverage) {
                Text(
                    text = stringResource(
                        if (showFrequency) R.string.report_chart_composition_average_records
                        else R.string.report_chart_composition_average_duration,
