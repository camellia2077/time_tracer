...
#ifndef REPORTS_PERIOD_FORMATTERS_MARKDOWN_PERIOD_MD_FORMATTER_H_
#define REPORTS_PERIOD_FORMATTERS_MARKDOWN_PERIOD_MD_FORMATTER_H_
...
class PeriodMdFormatter
    : public BaseMdFormatter<PeriodReportData, PeriodMdConfig> {
 public:
 ...
 protected:
  ...
  void format_header_content(std::stringstream& ss,
                             const PeriodReportData& data) const override;
};

}  // namespace reporting

#endif  // REPORTS_PERIOD_FORMATTERS_MARKDOWN_PERIOD_MD_FORMATTER_H_