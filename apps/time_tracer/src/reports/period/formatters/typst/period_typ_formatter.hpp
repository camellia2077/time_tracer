...
#ifndef REPORTS_PERIOD_FORMATTERS_TYPST_PERIOD_TYP_FORMATTER_H_
#define REPORTS_PERIOD_FORMATTERS_TYPST_PERIOD_TYP_FORMATTER_H_
...
class PeriodTypFormatter
    : public BaseTypFormatter<PeriodReportData, PeriodTypConfig> {
 public:
...
#endif  // REPORTS_PERIOD_FORMATTERS_TYPST_PERIOD_TYP_FORMATTER_H_