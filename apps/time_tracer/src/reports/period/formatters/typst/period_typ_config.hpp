...
#ifndef REPORTS_PERIOD_FORMATTERS_TYPST_PERIOD_TYP_CONFIG_H_
#define REPORTS_PERIOD_FORMATTERS_TYPST_PERIOD_TYP_CONFIG_H_
...
#endif  // REPORTS_PERIOD_FORMATTERS_TYPST_PERIOD_TYP_CONFIG_H_