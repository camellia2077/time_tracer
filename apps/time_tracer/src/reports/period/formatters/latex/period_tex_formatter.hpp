...
#ifndef REPORTS_PERIOD_FORMATTERS_LATEX_PERIOD_TEX_FORMATTER_H_
#define REPORTS_PERIOD_FORMATTERS_LATEX_PERIOD_TEX_FORMATTER_H_
...
class PeriodTexFormatter
    : public BaseTexFormatter<PeriodReportData, PeriodTexConfig> {
 public:
...
#endif  // REPORTS_PERIOD_FORMATTERS_LATEX_PERIOD_TEX_FORMATTER_H_