...
double RangeTypConfig::get_margin_top_cm() const { return margin_top_cm_; }
double RangeTypConfig::get_margin_bottom_cm() const { return margin_bottom_cm_; }
double RangeTypConfig::get_margin_left_cm() const { return margin_left_cm_; }
double RangeTypConfig::get_margin_right_cm() const { return margin_right_cm_; }
