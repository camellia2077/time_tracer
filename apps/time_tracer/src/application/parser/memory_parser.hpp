// application/parser/memory_parser.hpp
#ifndef APPLICATION_PARSER_MEMORY_PARSER_H_
#define APPLICATION_PARSER_MEMORY_PARSER_H_
...
#endif  // APPLICATION_PARSER_MEMORY_PARSER_H_
