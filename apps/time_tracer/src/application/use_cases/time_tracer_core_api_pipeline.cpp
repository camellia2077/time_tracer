// application/use_cases/time_tracer_core_api_pipeline.cpp
#include <exception>
#include <stdexcept>
#include <utility>
...
TimeTracerCoreApi::TimeTracerCoreApi(
...
auto TimeTracerCoreApi::RunConvert(const ConvertRequest& request)
    -> OperationAck {
  try {
    AppOptions options;
...
auto TimeTracerCoreApi::RunIngest(const IngestRequest& request)
    -> OperationAck {
  try {
...
auto TimeTracerCoreApi::RunImport(const ImportRequest& request)
    -> OperationAck {
  try {
...
auto TimeTracerCoreApi::RunValidateStructure(
...
auto TimeTracerCoreApi::RunValidateLogic(const ValidateLogicRequest& request)
    -> OperationAck {
  try {
