// core/helpers/file_import_reader.hpp
#ifndef CORE_HELPERS_FILE_IMPORT_READER_HPP_
#define CORE_HELPERS_FILE_IMPORT_READER_HPP_
...
#endif // CORE_HELPERS_FILE_IMPORT_READER_HPP_