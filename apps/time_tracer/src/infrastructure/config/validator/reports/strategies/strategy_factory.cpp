// infrastructure/config/validator/reports/strategies/strategy_factory.cpp
#include "infrastructure/config/validator/reports/strategies/strategy_factory.hpp"

#include <memory>
#include <string>

#include "infrastructure/config/validator/reports/strategies/daily/daily_md.hpp"
#include "infrastructure/config/validator/reports/strategies/daily/daily_tex.hpp"
