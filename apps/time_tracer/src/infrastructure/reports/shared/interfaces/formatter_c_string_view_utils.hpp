...
#ifndef REPORTS_SHARED_INTERFACES_FORMATTER_C_STRING_VIEW_UTILS_H_
#define REPORTS_SHARED_INTERFACES_FORMATTER_C_STRING_VIEW_UTILS_H_
...
#endif  // REPORTS_SHARED_INTERFACES_FORMATTER_C_STRING_VIEW_UTILS_H_
