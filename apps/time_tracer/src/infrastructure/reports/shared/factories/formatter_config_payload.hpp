...
#ifndef INFRASTRUCTURE_REPORTS_SHARED_FACTORIES_FORMATTER_CONFIG_PAYLOAD_H_
#define INFRASTRUCTURE_REPORTS_SHARED_FACTORIES_FORMATTER_CONFIG_PAYLOAD_H_
...
#endif  // INFRASTRUCTURE_REPORTS_SHARED_FACTORIES_FORMATTER_CONFIG_PAYLOAD_H_
