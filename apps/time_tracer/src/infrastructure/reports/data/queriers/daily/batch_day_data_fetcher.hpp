// infrastructure/reports/data/queriers/daily/batch_day_data_fetcher.hpp
#ifndef REPORTS_DATA_QUERIERS_DAILY_BATCH_DAY_DATA_FETCHER_H_
#define REPORTS_DATA_QUERIERS_DAILY_BATCH_DAY_DATA_FETCHER_H_
