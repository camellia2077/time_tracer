...
This directory hosts infrastructure-level tests for `apps/tracer_core_shell`.
...
2. `python tools/run.py verify --app tracer_core --build-dir build_fast --scope libs --concise`
