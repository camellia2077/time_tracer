...
function(_setup_target_common TARGET_NAME)
    ...
    if(NOT STC_NO_APP_SOURCE_ROOT_INCLUDE)
        target_include_directories(${TARGET_NAME} PRIVATE
            "${TT_TRACER_CORE_APP_SOURCE_ROOT}"
        )
    endif()
    if(EXISTS "${TT_TRACER_CORE_LIB_SOURCE_ROOT}")
        target_include_directories(${TARGET_NAME} PRIVATE
            "${TT_TRACER_CORE_LIB_SOURCE_ROOT}"
        )
    endif()
    ...
    if(WIN32 AND CMAKE_RC_COMPILER AND ENABLE_APP_ICON)
        ...
        if(TARGET_TYPE STREQUAL "EXECUTABLE")
            set(TT_ICON_RESOURCE_RC "${PROJECT_SOURCE_DIR}/resources/app_icon.rc")
