// infrastructure/persistence/sqlite_data_query_service_internal.hpp
...
auto ApplyTreePeriod(
    const tracer_core::core::dto::DataQueryRequest& request, sqlite3* db_conn,
    tracer_core::infrastructure::query::data::QueryFilters& filters) -> void;

auto DispatchDataQueryAction(
    sqlite3* db_conn, const tracer_core::core::dto::DataQueryRequest& request,
    tracer_core::infrastructure::query::data::DataQueryAction action,
    const tracer_core::infrastructure::query::data::QueryFilters& base_filters)
