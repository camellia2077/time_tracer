...
# Import the centralized data access function
import db_access
...
def main():
    ...
    parser.add_argument("-p", "--project", type=str, default="mystudy", help='要生成热力图的父项目 (例如 "code")。\n默认为 "study"。')
    ...
    try:
        ...
        # 2. 从数据库获取数据 (using the data access layer)
