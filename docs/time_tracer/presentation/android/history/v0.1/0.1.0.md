...
* 新增单仓 `apps/android`（Jetpack Compose + JNI）宿主工程，打通最小调用链
...
* 重构 ViewModel 分层：
  * `apps/android/feature-data/.../DataViewModel.kt`
  * `apps/android/feature-report/.../QueryReportViewModel.kt`
  * `apps/android/feature-record/.../RecordViewModel.kt`
* 重构 Screen 仅负责 Compose 视图拼装与事件分发：
  * `apps/android/feature-data/.../DataScreen.kt`
  * `apps/android/feature-report/.../QueryReportScreen.kt`
  * `apps/android/feature-record/.../RecordScreen.kt`
  * `apps/android/app/.../TracerScreen.kt`
* 重构 Runtime/Bridge 职责目录化：
  * `apps/android/runtime/.../runtime/**`
  * `apps/android/runtime/.../bridge/**`
...
* **P2 Step 9-14 适配收口完成清单**：
  ...
  * 已完成 Step 13 测试补强：
    ...
    * 新增 `apps/android/feature-report/src/test/java/com/example/tracer/QueryPeriodArgumentResolverTest.kt`
    * 新增 `apps/android/feature-report/src/test/java/com/example/tracer/QueryReportViewModelStatsTest.kt`
    * 新增 `apps/android/app/src/androidTest/java/com/example/tracer/TracerScreenStatsMarkdownRenderTest.kt`
