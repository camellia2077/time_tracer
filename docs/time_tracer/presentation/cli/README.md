...
2. 推荐命令：
   - `python tools/run.py verify --app tracer_core_shell --build-dir build_fast --scope cli --concise`
   - `python tools/run.py verify --app tracer_core --profile fast --scope cli --concise`
