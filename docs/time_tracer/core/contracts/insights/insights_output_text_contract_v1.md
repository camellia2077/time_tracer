# Insights Output Text Contract v1
...
2. Android 输出策略：`apps/android/runtime/src/main/java/com/example/tracer/runtime/translators/InsightsOutputPolicy.kt`
3. Core formatter parity tests：`libs/tracer_core/src/infra/tests/insights_formatter/`
