...
代码位置：
1. `libs/tracer_core/src/infra/query/data/orchestrators/date_range_resolver.cpp`
2. `libs/tracer_core/src/infra/query/data/orchestrators/date_range_resolver.hpp`
3. `libs/tracer_core/src/infra/query/data/orchestrators/list_query_orchestrator.cpp`
...
代码位置：
1. `libs/tracer_core/src/infra/query/data/renderers/data_query_renderer.cpp`
2. `libs/tracer_core/src/infra/query/data/renderers/data_query_renderer.hpp`
3. `libs/tracer_core/src/infra/query/data/renderers/text_renderer.cpp`
4. `libs/tracer_core/src/infra/query/data/renderers/text_renderer.hpp`
5. `libs/tracer_core/src/infra/query/data/renderers/semantic_json_renderer.cpp`
6. `libs/tracer_core/src/infra/query/data/renderers/semantic_json_renderer.hpp`
...
2. `apps/cli/windows/src/api/cli/impl/commands/query/query_command.cpp`
3. `apps/cli/windows/src/bootstrap/cli_runtime_factory_proxy.cpp`
...
4. 改 CLI 参数语义：`apps/cli/windows/src/api/cli/impl/commands/query/data_query_parser.cpp`
