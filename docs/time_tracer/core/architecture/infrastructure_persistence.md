...
其目录位于：`libs/tracer_core/src/infrastructure/`
...
**核心基建**：`libs/tracer_core/src/infrastructure/persistence/importer/sqlite/writer.cpp`
...
**核心基建**：`libs/tracer_core/src/infrastructure/persistence/importer/sqlite/project_resolver.cpp`
...
**核心基建**：`libs/tracer_core/src/infrastructure/persistence/sqlite_data_query_service.cpp`
