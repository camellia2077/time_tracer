...
`docs/tools/toolchain/` 是 Python 工具链、测试契约与工程执行规则的权威文档目录。
...
1. [tools/README.md](tools/README.md)
   - `tools/run.py`、`tools/test.py`、`tools/lint_suites.py` 入口，以及
     `tools/` / `test/` 当前目录职责索引
2. [docs/tools/toolchain/test/README.md](test/README.md)
