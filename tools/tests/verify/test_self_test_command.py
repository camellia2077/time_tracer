...
class TestSelfTestCommand(TestCase):
    ...
    def test_execute_verify_stack_group_dispatches_named_subset(self):
        ...
        self.assertIn("tools.tests.platform.tidy.test_tidy_source_step", called_cmd)
        self.assertIn("tools.tests.run_cli.test_run_cli_dispatch_core_format", called_cmd)
        self.assertIn("tools.tests.run_cli.test_run_cli_dispatch_tidy_source_step", called_cmd)
