...
def plan_braces_around_statement_actions(parsed) -> list[AutoFixAction]:
    return _plan_rule_actions(parsed, BracesAroundStatementsRule())
...
__all__ = [
    ...
    "plan_braces_around_statement_actions",
]
