...
def report_paths(build_tidy_dir: Path, cluster_id: str, task_id: str, suffix: str) -> tuple[Path, Path]:
    automation_dir = build_tidy_dir / "automation"
    stem = f"{cluster_id}_task_{task_id}_{suffix}"
