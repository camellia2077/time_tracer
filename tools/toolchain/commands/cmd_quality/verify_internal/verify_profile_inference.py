...
_OWNER_PROFILE_RULES: tuple[tuple[str, str], ...] = (
    ...
    (
        "tools/suites/tracer_windows_rust_cli/config_cap_persistence_runtime.toml",
        "cap_persistence_runtime",
    ),
    (
        "tools/suites/tracer_windows_rust_cli/config_cap_persistence_write.toml",
        "cap_persistence_write",
    ),
    ...
    (
        "tools/suites/tracer_windows_rust_cli/tests/commands_persistence_runtime.toml",
        "cap_persistence_runtime",
    ),
    (
...
_NON_OWNER_SHELL_PROFILE_RULES: tuple[tuple[str, str], ...] = (
    ...
    ("tools/suites/tracer_windows_rust_cli/tests/commands_shell_aggregate.toml", "shell_aggregate"),
    ("tools/suites/tracer_windows_rust_cli/tests/commands_failure_modes.toml", "shell_aggregate"),
    ("tools/suites/tracer_windows_rust_cli/tests/commands_tree_version.toml", "shell_aggregate"),
)
