...
class InsightsMarkdownGateCommand:
    ...
    def _sync_and_print(
        ...
        *,
        ...
        print(
            f"--- insights-markdown-gate: refreshed {scope_name} "
    ...
    def execute(
        ...
        *,
        ...
        if app_name not in {"tracer_core", "tracer_core_shell"}:
            print(
                "Error: insights-markdown-gate currently supports "
        ...
        # prefer pre-exchange insights snapshot to avoid DB drift after
        ...
        if refresh_golden:
            self._sync_and_print(
                ...
                pattern="*.md",
                scope_name="insights_markdown/v1",
            )
        ...
        for fmt, export_dir_name, pattern in triplet_specs:
            ...
            if refresh_golden:
                self._sync_and_print(
                    ...
                    pattern=pattern,
                    scope_name=f"insights_triplet/{fmt}/v1",
                )
