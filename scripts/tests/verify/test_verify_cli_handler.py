...
from toolchain.cli.handlers.quality import verify as verify_handler  # noqa: E402
...
class TestVerifyCliHandler(TestCase):
    ...
    def test_run_quick_sets_build_fast_and_concise(self):
        ...
        with patch("toolchain.cli.handlers.quality.verify.VerifyCommand") as mocked_command:
