---
description: Shared base policy for one numbered time_tracer clang-tidy task (profile-agnostic)
---
...
- After that, close the batch with `tidy-batch --preset sop <PROFILE_BATCH_FLAGS>`.
